...
object LocalProfilePlugin : PluginBase(PluginDescription()
    ...
    fun isValidEditState(): Boolean {
        return createProfileStore().defaultProfile?.isValid(MainApp.gs(R.string.localprofile), false) ?: false
    }
    ...
    fun storeSettings() {
        ...
        MainApp.bus().post(EventProfileStoreChanged())
    }
    ...
    override fun getProfileName(): String {
        return DecimalFormatter.to2Decimal(rawProfile?.defaultProfile?.percentageBasalSum() ?: 0.0) + "U "
    }
